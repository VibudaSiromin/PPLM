...
X = torch.load("train_hidden_states_qwen.pt")  # [N, hidden_size]
y = torch.load("train_labels_qwen.pt")         # [N]
...
}, "discriminator_qwen.pt")

print("✅ MLP Discriminator saved to discriminator_qwen.pt")
